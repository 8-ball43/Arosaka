...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT SUM(kwota) FROM wplaty INNER JOIN uzytkownicy ON wplaty.id_uzytkownika = uzytkownicy.id_uzytkownika  WHERE uzytkownicy.adres = '$user' AND opis = '$value_name'";
    $result_1 = mysqli_query($conn, $sql);
    if($money > $result_1){
        echo("brak takiej ilości srodków");
    }
    else {
